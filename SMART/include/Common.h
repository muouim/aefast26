...
// app thread
#define MAX_APP_THREAD 80    // one additional thread for data statistics(main thread)  [config]
...
// Remote Allocation
constexpr uint64_t dsmSize           = 2;        // GB  [CONFIG]
...
// Cache (MB)
constexpr int kIndexCacheSize = 1024 * 60;
...
// Internal Node
constexpr uint32_t allocationPageSize = 8 + 8 + 16 * 8;
