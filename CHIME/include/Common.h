...
#define CPU_PHYSICAL_CORE_NUM 80  // [CONFIG]  72
...
// app thread
#define MAX_APP_THREAD 80   // one additional thread for data statistics(main thread)  [CONFIG] 65
...
// Cache (MB)
constexpr int kIndexCacheSize  = 10 * 1024;  // MB including kHotspotBufSize 
constexpr int kHotspotBufSize  = 5 * 1024;
...
// Internal Node
constexpr uint32_t internalSpanSize = 32;
...
// Allocation Size
constexpr uint32_t allocationLockSize = 64UL;  // round up lock_addr
