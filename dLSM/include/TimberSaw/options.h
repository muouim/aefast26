...
// default 8 8  1
#define RDMA_WRITE_BLOCK  (64*1024*1024ULL)

#define INDEX_BLOCK_BIG (64*1024*1024ULL)
#define INDEX_BLOCK_SMALL (48*1024*1024ULL)
#define FILTER_BLOCK  (8*1024*1024ULL)
...
//  int max_open_files = 1082; // byte-addressable limited 682
  ...
  std::vector<std::pair<std::string,std::string>>* StringShardInfo = nullptr;// [Lower bound, upper bound)
};
